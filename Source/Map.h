...
public:
    ...
    void addCheep(
        int X, int Y, int minionType, int moveSpeed, bool moveDirection = false);
    ...
    void
        structGND2(int X, int Y, int iSize, bool bDir); // true = LEFT, false = RIGHT
